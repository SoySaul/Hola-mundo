...
document.querySelector("#datos-usuario").textContent = nombreUsuario + " " + apellidoUsuario;
...
let salarioSemanal = salarioMensual / 7;
let salarioDelDia = salarioAnual / 365;
let salarioPorHora = salarioDelDia / 24;
document.querySelector("#resultado-salario-mensual").value = salarioMensual;
document.querySelector("#resultado-salario-semanal").value = salarioSemanal;
document.querySelector("#resultado-salario-del-dia").value = salarioDelDia;
document.querySelector("#resultado-salario-por-hora").value = salarioPorHora;
